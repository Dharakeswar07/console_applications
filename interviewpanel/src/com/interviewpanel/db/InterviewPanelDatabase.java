...
public class InterviewPanelDatabase {
    ...
    public Map<Integer, String> getHashList()
    {
        return statusMap;
    }
    ...
    public void hasAdd()
    {
        for (InterviewPanel interviewPanel : interviewPanelQueue) {
            int empId = interviewPanel.getEmployeeId();
            String status = interviewPanel.getStatus();
            statusMap.put(empId, status);
        }
    }
...
public void candidateListExport()
{
    ...
    public void loadDataFromJsonFiles() {
        adminList = jsonModule.convertJsonToList("src/com/interviewpanel/data/Admin.json", Admin.class);
        creditantialsList = jsonModule.convertJsonToList("src/com/interviewpanel/data/Credentials.json", Creditantials.class);
        candidatesList = jsonModule.convertJsonToList("src/com/interviewpanel/data/Candidate.json", Candidate.class);
        interviewPanelList = jsonModule.convertJsonToList("src/com/interviewpanel/data/InterviewPanel.json", InterviewPanel.class);
        employeeList = jsonModule.convertJsonToList("src/com/interviewpanel/data/Employee.json", Employee.class);
        interviewPanelQueue=jsonModule.convertJsonToQueue("src/com/interviewpanel/data/InterviewPanelQueue.json",InterviewPanel.class);
        hasAdd();
    }
